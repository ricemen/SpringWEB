...
public class SimpleHelloController extends AbstractDispatcherServletTest {
	...
	public void helloController() throws ServletException, IOException {
		ModelAndView mav = setRelativeLocations("spring-servlet.xml")
				...
				.addParameter("name", "Fuck postvisual")
				.runService()
				.getModelAndView();
		
		assertThat(mav.getViewName(), is("/WEB-INF/view/hello.jsp"));
		assertThat(mav.getModel().get("message"), is("Hello Fuck postvisual"));
